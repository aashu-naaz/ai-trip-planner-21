    ...
    return (
        <div className='p-0 md:p-0 lg:p-0 xl:p-0 fixed bottom-0 top-16 left-0 right-0 overflow-hidden'>
            ...
            <ResizablePanelGroup orientation="horizontal" className="h-full">
                {/* Itinerary Section */}
                <ResizablePanel defaultSize={60} minSize={30} className='overflow-y-auto h-full pb-20'>
                    ...
                    <div ref={componentRef} className="h-full">
                        ...
                        {/* Footer for PDF - visible only when printing */}
                        <div className="hidden print:block p-10 text-center text-gray-400 text-sm">
                            <p>Generated by SmartJourney AI</p>
                        </div>
                    </div>
                </ResizablePanel>
                ...
                {/* Globe Section */}
                <ResizablePanel defaultSize={40} minSize={30} className='h-full relative border-l border-white/10 hidden md:block'>
