    ...
    const data = [
        {
            ...
            content: (
                <div className='grid grid-cols-1 lg:grid-cols-2 gap-5'>
                    <div className='border rounded-xl p-4 hover:scale-105 transition-all cursor-pointer shadow-sm'>
                        <img src="https://images.unsplash.com/photo-1566073771259-6a8506099945?q=80&w=2070&auto=format&fit=crop" className='rounded-xl h-[180px] w-full object-cover' />
                    ...
                    <div className='border rounded-xl p-4 hover:scale-105 transition-all cursor-pointer shadow-sm'>
                        <img src="https://images.unsplash.com/photo-1551882547-ff40c63fe5fa?q=80&w=2070&auto=format&fit=crop" className='rounded-xl h-[180px] w-full object-cover' />
                        <div className='my-2 flex flex-col gap-2'>
            ...
            content: (
                <div className='grid grid-cols-1 md:grid-cols-2 gap-5'>
                    <div className='p-4 border rounded-lg shadow-sm bg-white hover:shadow-md transition-all'>
                        ...
                        <img src="https://images.unsplash.com/photo-1502602898657-3e91760cbb34?q=80&w=1000&auto=format&fit=crop" className='rounded-lg h-[150px] w-full object-cover mb-3' />
                    ...
                    <div className='p-4 border rounded-lg shadow-sm bg-white hover:shadow-md transition-all'>
                        ...
                        <img src="https://images.unsplash.com/photo-1565099824688-e93eb20fe622?q=80&w=1000&auto=format&fit=crop" className='rounded-lg h-[150px] w-full object-cover mb-3' />
            ...
            content: (
                <div className='grid grid-cols-1 md:grid-cols-2 gap-5'>
                    <div className='p-4 border rounded-lg shadow-sm bg-white hover:shadow-md transition-all'>
                        ...
                        <img src="/disneyland.png" className='rounded-lg h-[150px] w-full object-cover mb-3 shadow-md' />
                    ...
                    <div className='p-4 border rounded-lg shadow-sm bg-white hover:shadow-md transition-all'>
                        ...
                        <img src="/pantheon.png" className='rounded-lg h-[150px] w-full object-cover mb-3 shadow-md' />
